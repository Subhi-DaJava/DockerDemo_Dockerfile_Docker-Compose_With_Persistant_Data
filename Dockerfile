...
# 2. docker run -d -p 3308:3306 --name=mysql-docker-demo-container --env="MYSQL_ROOT_PASSWORD=rootPasword" --env="MYSQL_PASSWORD=routPasword" --env="MYSQL_DATABASE=docker_demo_db" mysql ( d- detach mode-running background,
...
# 3. docker run -t --link mysql-docker-demo-container:mysql -p 9081:9081 docker-demo-31052023

#  docker run -t --env="MYSQL_HOST=mysql-docker-demo-container" --link mysql-docker-demo-container:mysql -p 9081:9081 docker-demo
  #-30052023